...
**The cover is the hook and is allowed to shout.** It is the piggy bank cracking
open over him on the village road at dusk — the loudest thing that happens in
this game and the only moment the whole screen is about him — graded up in
saturation and contrast because a thumbnail is competing with forty others
rather than sitting on a screen you are already looking at, with a vignette, his
face staring up out of a circle in the corner, a gold arrow from one to the
other, and the title set with a black edge on it because gold on gold is not
type.

**The banner is the game, wide and quiet.** The temple at twenty past seven in
the morning, gold bell and chedi against the hills, the logo on the left over a
gradient that gets out of the way of everything you would want to look at.
...
| `title-1440x810.png` | the temple at first light, at 3× | **Screenshots** |
